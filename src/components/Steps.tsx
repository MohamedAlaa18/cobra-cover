...
function Steps() {
    ...
    return (
        <ol className='rounded-md bg-white lg:flex lg:rounded-none lg:border-l lg:border-r border-gray-200'>
                        ...
                        <div>
                            ...
                            <span className={cn(index !== 0 ? 'lg:pl-9' : '', 'flex items-center px-6 py-4 text-sm font-medium')} >
                                <span className='flex-shrink-0'>
                                    <Image width={200} height={200} src={imgPath} alt='snake' priority className={cn('flex h-20 w-20 items-center justify-center',
                                        {
                                ...
                                <span className='ml-4 h-full mt-0.5 flex min-w-0 flex-col justify-center'>
                                    <span className={cn('text-sm font-semibold text-zinc-900',
                                        {
